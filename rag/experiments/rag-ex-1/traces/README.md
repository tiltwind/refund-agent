...
从 run `baseline-5` 导出的 102 条，供[基线报告](../baseline-report.md)逐条引用。
...
| [R1-060](./R1-060.md) | 种子块没进候选 | single / colloquial / table |
| [R1-087](./R1-087.md) | 种子块没进候选 | multi_hop / formal / table |
| [R1-088](./R1-088.md) | 种子块没进候选 | multi_hop / colloquial / table |
...
| [R1-086](./R1-086.md) | 种子块在候选里排第 1/11 | multi_hop / colloquial / table+text |
...
| [R1-046](./R1-046.md) | 候选第 2 → 证据第 12，重排压下去了；证据里 43% 是重复正文 | single / colloquial / table |
| [R1-050](./R1-050.md) | 候选第 3 → 证据第 11，重排压下去了 | single / colloquial / table |
| [R1-070](./R1-070.md) | 候选第 3 → 证据第 8，重排压下去了；证据里 55% 是重复正文 | single / colloquial / table |
| [R1-082](./R1-082.md) | 候选第 9/4 → 证据第 13/3，重排压下去了 | multi_hop / colloquial / table+text |
| [R1-084](./R1-084.md) | 候选第 3/1 → 证据第 5/1，重排压下去了；证据里 50% 是重复正文 | multi_hop / colloquial / table+text |
| [R1-085](./R1-085.md) | 候选第 2/8 → 证据第 1/9，重排压下去了；证据里 45% 是重复正文 | multi_hop / formal / table+text |
| [R1-092](./R1-092.md) | 候选第 5/6 → 证据第 5/6，重排提了名次但仍不在前 3 | multi_hop / colloquial / table+text |
| [R1-094](./R1-094.md) | 候选第 4/1 → 证据第 1/5，重排压下去了 | multi_hop / colloquial / text |
| [R1-096](./R1-096.md) | 候选第 3/7，被 MIN_SCORE 滤掉 | multi_hop / colloquial / text |
...
| [R1-099](./R1-099.md) | 语料里没有的问题，链路返回了证据 | unanswerable / colloquial /  |
| [R1-100](./R1-100.md) | 语料里没有的问题，链路返回了证据 | unanswerable / colloquial /  |
| [R1-101](./R1-101.md) | 语料里没有的问题，链路返回了证据 | unanswerable / colloquial /  |
| [R1-102](./R1-102.md) | 语料里没有的问题，链路返回了证据 | unanswerable / colloquial /  |
...
| 用例 | 读点 | 分类 |
|---|---|---|
| [R1-083](./R1-083.md) | 命中，但排第 2/1；证据里 44% 是重复正文 | multi_hop / formal / table+text |
...
| [R1-093](./R1-093.md) | 命中，但排第 2/1 | multi_hop / formal / text |
| [R1-095](./R1-095.md) | 命中，但排第 3/1 | multi_hop / formal / text |
...
| [R1-010](./R1-010.md) | 三档全中 | single / colloquial / text |
...
| [R1-066](./R1-066.md) | 三档全中；证据里 44% 是重复正文 | single / colloquial / text |
| [R1-068](./R1-068.md) | 三档全中 | single / colloquial / text |
| [R1-071](./R1-071.md) | 三档全中；证据里 45% 是重复正文 | single / formal / text |
...
| [R1-079](./R1-079.md) | 三档全中 | single / formal / table |
| [R1-080](./R1-080.md) | 三档全中 | single / colloquial / table |
...
| 用例 | 读点 | 分类 |
|---|---|---|
| [R1-001](./R1-001.md) | 命中，但排第 2；证据里 47% 是重复正文 | single / formal / text |
...
| [R1-064](./R1-064.md) | 命中，但排第 3；证据里 43% 是重复正文 | single / colloquial / table |
